...
type SuperbGraphQLGraphqlClient(url: string, headers: Header list) =
    ...
    member _.GetTables(input: GetTables.InputVariables) =
        async {
            ...
            | 200 ->
                let response = Json.parseNativeAs<GraphqlSuccessResponse<GetTables.Query>> response.responseText
    ...
    member _.GetTcpListeners() =
        async {
            ...
            match response.statusCode with
            | 200 ->
                let response = Json.parseNativeAs<GraphqlSuccessResponse<GetTcpListeners.Query>> response.responseText
                return Ok response.data
    ...
    member _.GetHackerNewsStories() =
        async {
            ...
            match response.statusCode with
            | 200 ->
                let response = Json.parseNativeAs<GraphqlSuccessResponse<GetHackerNewsStories.Query>> response.responseText
                return Ok response.data
    ...
    member _.GetSchemata() =
        async {
            ...
            match response.statusCode with
            | 200 ->
                let response = Json.parseNativeAs<GraphqlSuccessResponse<GetSchemata.Query>> response.responseText
                return Ok response.data
    ...
    member _.ExecuteRedisCLICommand(input: ExecuteRedisCLICommand.InputVariables) =
        async {
            ...
            match response.statusCode with
            | 200 ->
                let response = Json.parseNativeAs<GraphqlSuccessResponse<ExecuteRedisCLICommand.Query>> response.responseText
                return Ok response.data
